...
<html lang="">
 ...
 background-color: rgb(226, 230, 173);
  ...
  background-position: center;
    ...
    <body>
	<h1 class="formdesign">Clothes Form</h1>
        <div class="col-md-3">
        </div>
        <div class="col-md-6">
        <form name="myForm" action="donor_db.php"  method="POST" class="form-horizontal" role="form" >
       ...
       <div class="formdesign input" >
        ...
        <div class='formdesign1' id="req1">
            ...
            <b>How many sets of clothes: 
			
			<input type="text" name="req" id="food">
			<br><br><label id = "checkBoxes" style="color:red;"></label>
